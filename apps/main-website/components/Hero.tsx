...
import { ArrowRight, Bot, MessageCircle, Sparkles, Zap } from "lucide-react";
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    >
                        ...
                        <div className="relative flex items-center gap-2 px-6 py-2 rounded-full bg-slate-900/[0.03] border border-slate-900/10 text-slate-600 text-[12px] font-bold uppercase tracking-[0.3em] mb-12 backdrop-blur-sm overflow-hidden group">
                            ...
                            L&apos;ÉCOSYSTÈME IA POUR L&apos;AFRIQUE
                    ...
                    <motion.div
                        ...
                        className="relative"
                    >
                        <h1 className="text-6xl md:text-8xl lg:text-[130px] leading-[0.9] font-[900] text-slate-950 tracking-[-0.06em] max-w-6xl mb-12">
                            Vos agents IA, <br className="hidden md:block" />
                    ...
                    >
                        Créez des agents IA intelligents, connectez-les à WhatsApp et automatisez vos opérations. <b className="text-slate-900">Bienvenue dans l&apos;ère Connect.</b>
                    </motion.p>
                    ...
                    >
                        ...
                        <Link
                            href="#connect"
                            className="group flex items-center gap-4 text-sm font-black text-slate-900 uppercase tracking-widest hover:text-indigo-600 transition-colors"
                        >
                            <div className="relative w-14 h-14 rounded-full border border-slate-200 flex items-center justify-center transition-all group-hover:border-indigo-100 group-hover:bg-indigo-50 shadow-sm">
                                <Bot className="w-5 h-5 text-slate-900 group-hover:text-indigo-600 relative z-10" />
            ...
            <div className="hidden xl:block absolute inset-0 pointer-events-none overflow-hidden">
                ...
                >
                    <div className="flex items-center gap-5">
                        ...
                        <div>
                            ...
                            <div className="text-lg font-black text-slate-950">Intégré nativement</div>
                        </div>
                    </div>
                </motion.div>
                ...
                >
                    <div className="flex items-center gap-5">
                        ...
                        <div>
                            <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Agents IA</div>
                            <div className="text-lg font-black text-slate-950">Multi-modèles</div>
                        </div>
                    </div>
                </motion.div>
            </div>
