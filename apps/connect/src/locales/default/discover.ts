export default {
  ...
  'createGuide.func1.title': 'Submit in Connect',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the Connect Community.',
  'footer.title': 'Share your creation on Connect Community today',
  ...
  'models.providerInfo.apiTooltip': 'Connect supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'Connect Official Service',
