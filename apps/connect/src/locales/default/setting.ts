export default {
  ...
  'about.title': 'About',
  'agentActivation.activated': 'Agent activated successfully',
  'agentActivation.active': 'Active',
  'agentActivation.deactivated': 'Agent deactivated',
  'agentActivation.error': 'Error changing agent status',
  'agentActivation.inactive': 'Inactive',
  ...
  'memory.enabled.desc':
    'Allow Connect to extract preferences and info from conversations and use them later. You can view, edit, or clear memory anytime.',
  ...
  'skillStore.tabs.lobehub': 'Connect',
