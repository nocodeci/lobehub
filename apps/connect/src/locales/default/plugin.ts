export default {
  ...
  'protocolInstall.official.badge': 'Connect Official Skill',
  'protocolInstall.official.description': 'Official Connect Skill, verified and security-checked.',
  ...
  'skillInstallBanner.title': 'Add skills to Connect',
