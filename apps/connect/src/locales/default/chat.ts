export default {
  ...
  'sharePageDisclaimer':
    'This content is shared by a user and does not represent the views of Connect. Connect is not responsible for any consequences arising from this shared content.',
