export default {
  ...
  'authResult.success.desc':
    'Please click the Start button below to continue using Connect Desktop',
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve Connect. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve Connect',
  ...
  'screen5.actions.signInCloud': 'Sign in to Connect Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your Connect Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'Connect Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own Connect server instance',
