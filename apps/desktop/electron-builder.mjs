...
const getProtocolScheme = () => {
  if (isNightly) return 'connect-nightly';
  if (isBeta) return 'connect-beta';
...
const config = {
  ...
  appId: isNightly
    ? 'com.wozif.connect-desktop-nightly'
    : isBeta
      ? 'com.wozif.connect-desktop-beta'
      : 'com.wozif.connect-desktop',
  appImage: {
  ...
  mac: {
    ...
    extendInfo: {
      ...
      CFBundleURLTypes: [
        {
          CFBundleURLName: 'Connect Protocol',
