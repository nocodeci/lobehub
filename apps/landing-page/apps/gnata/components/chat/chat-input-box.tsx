...
const aiModels = [
  { id: "square-3", label: "Gnata AI 3.0", icon: SparklesIcon },
  { id: "square-turbo", label: "Gnata AI Turbo", icon: SparklesIcon },
  { id: "square-pro", label: "Gnata AI Pro", icon: SparklesIcon },
  { id: "square-ultra", label: "Gnata AI Ultra", icon: SparklesIcon },
];
