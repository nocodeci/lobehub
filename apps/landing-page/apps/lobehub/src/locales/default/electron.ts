export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote Connect server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'Connect Cloud',
