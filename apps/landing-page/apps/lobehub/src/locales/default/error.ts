export default {
  ...
  'inviteCode.desc':
    'An invite code is required to access Connect. Please enter a valid invite code to continue.',
  ...
  'response.AgentRuntimeError':
    'Connect language model runtime execution error. Please troubleshoot or retry based on the following information.',
