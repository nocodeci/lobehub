...
const InboxWelcome = memo(() => {
  ...
  const displayTitle = isInbox ? BRANDING_NAME : meta.title || t('defaultSession', { ns: 'common' });
    ...
    <>
      ...
      >
        <Avatar
          ...
          background={isInbox ? 'transparent' : meta.backgroundColor}
          shape={'square'}
          size={78}
        />
        ...
        <Flexbox width={'min(100%, 640px)'}>
          <Markdown fontSize={fontSize} variant={'chat'}>
            {isInbox ? t('guide.defaultMessageWithoutCreate', { appName: BRANDING_NAME }) : message}
          </Markdown>
        </Flexbox>
