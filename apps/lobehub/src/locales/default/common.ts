export default {
  ...
  'branchingDisable':
    'The "Sub-topic" feature is unavailable in the current mode. To use this feature, please switch to Postgres/Pglite DB mode or use Connect Cloud.',
  ...
  'cmdk.subscription': 'Subscription',
  'cmdk.usage': 'Usage',
