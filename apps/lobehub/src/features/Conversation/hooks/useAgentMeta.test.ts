...
describe('useAgentMeta', () => {
  ...
  it('should return branding title for builtin inbox agent, preserving avatar from backend', () => {
    ...
    expect(result.current.title).toBe(BRANDING_NAME);
    // Should preserve other properties
    expect(result.current.description).toBe('Inbox description');
  });

  it('should return branding title for page agent (builtin), preserving avatar from backend', () => {
